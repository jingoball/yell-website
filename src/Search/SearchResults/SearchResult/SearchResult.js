...
export function SearchResult(props){
    ...
    const addressLine = b.location.display_address.map(addressLine => <p key={b.id + addressLine}>{addressLine}</p>)

    return(
        <div className={styles['search-result']}>
            <img className={styles['business-image']} src={b.image_url} alt='business image'/>
